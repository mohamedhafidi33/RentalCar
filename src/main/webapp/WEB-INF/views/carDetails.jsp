                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <ul class="nav sf-menu">
                                ...
                                <li><a href="index.html#our-cars">Our Cars</a></li>
                                <li><a href="index.html#faqs">FAQS</a></li>
                                <li><a href="index.html#find-car-new">Find a Car</a></li>
                                <li><a href="index.html#blog-posts">Blog</a>
                                    <ul>
                                ...
                                <li><a href="index.html#help-desk">Help Desk</a></li>
                                ...
                                <div class="col-md-6">
                                    <div class="left">
                                        <div class="checkbox checkbox-danger">
                                            ...
                                            <label for="checkboxl1">Baby Seat <span class="pull-left">12 $ /for a day</span></label>
                                        </div>
                                        <div class="checkbox checkbox-danger">
                                            <input id="checkboxl2" type="checkbox">
                                            <label for="checkboxl2">Car Seat For Childres <span class="pull-left">12 $ /for a day</span></label>
                                        </div>
                                        <div class="checkbox checkbox-danger">
                                            <input id="checkboxl3" type="checkbox">
                                            <label for="checkboxl3">Navigation <span class="pull-left">42 $ /Total</span></label>
                                        </div>
                                        <div class="checkbox checkbox-danger">
                                            <input id="checkboxl4" type="checkbox">
                                            <label for="checkboxl4">Excess Protection <span class="pull-left">12 $ /for a day</span></label>
                                        </div>
                                        <div class="checkbox checkbox-danger">
                                            <input id="checkboxl5" type="checkbox">
                                            <label for="checkboxl5">Additional Driver <span class="pull-left">24 $ /Total</span></label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" role="tab" id="heading4">
                                    <h4 class="panel-title">
                                        ...
                                        <span class="overflowed pull-left"><img src="assets/img/preview/payments/paypal-2.jpg" alt=""/></span>
                                    </h4>
                                </div>
