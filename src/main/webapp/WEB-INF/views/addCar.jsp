              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form method="post" action="addCar" >
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="name" class="form-control" id="exampleInputUsername2" placeholder="nom">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="model" class="form-control" id="exampleInputEmail2" placeholder="depart">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputMobile" class="col-sm-3 col-form-label">Matricule</label>
                        <div class="col-sm-9">
                          <input type="text" name="matricule" class="form-control" id="exampleInputMobile" placeholder="destination">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputMobile" class="col-sm-3 col-form-label">Consommation</label>
                        <div class="col-sm-9">
                          <input type="text" name="consommation" class="form-control" id="exampleInputMobile" placeholder="destination">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Release date</label>
                        <div class="col-sm-9">
                          <input type="date" name="dateRelease" class="form-control" id="exampleInputPassword2" placeholder="date">
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="description" class="form-control" id="exampleInputConfirmPassword2" placeholder="durée">
                        </div>
                      </div>
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="price" id="exampleInputPassword2" placeholder="prix">
                        </div>
                      </div>
                      <div class="form-group row">
                  ...
                  <div class="form-group row">
                      ...
                      <input type="submit" value="ajouter" class="button button1" style="vertical-align:middle"><span></span>
